...
import com.Veiled.SyncAdapter.SyncAdapter;
 ...
 * manage the lifecycle of our {@link com.Veiled.SyncAdapter} and provide a handle to said SyncAdapter to the
 * OS on request.
 */
    ...
    public void onCreate() {
        ...
        synchronized (sSyncAdapterLock) {
            if (sSyncAdapter == null) {
                sSyncAdapter = new SyncAdapter(this, getApplicationContext(), true);
            }
        }
    }
